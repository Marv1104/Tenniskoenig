...
public final class GlobalVars {
    ...
    //Routen
    public static final String RouteHome = "";
    public static final String RouteSpielEintrage = "SpielEintragen";
    ...
    public static final String RouteHighscores = "Bestenliste";
